  ...
  return (
    <div className="home__data">
        ...
        <svg
                ...
                &nbsp; <span className='home__title-span'>I'm,</span>
        </h1>
        <h2 className='home__name'>Raghav Kashyap</h2>
        <h3 className="home__subtitle">Full Stack Developer</h3>
        <p className="home__description">I'm a creative developer based in Himachal Pradesh, India, and I'm very passionate and dedicated to my work.</p>
